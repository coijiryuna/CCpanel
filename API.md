...
| GET | `/api/sites` | Daftar site (+ info app: tipe, port, entry, subpath, state live) | login |
...
| Method | Endpoint | Fungsi | Akses |
|---|---|---|---|
| GET | `/api/sites/{id}/apps` | Status app per-site (state: active/inactive/stopped/running) | login |
...
| GET | `/api/dbs` | Daftar DB (client hanya miliknya) | login |
...
| Method | Endpoint | Fungsi | Akses |
|---|---|---|---|
| GET | `/api/trash` | Daftar item trash (nama, size, mtime) | admin |
...
| Method | Endpoint | Fungsi | Akses |
|---|---|---|---|
| GET | `/api/logs` | Audit trail aksi (limit 1-500, default 100) | admin |
...
| Method | Endpoint | Fungsi | Akses |
|---|---|---|---|
| GET | `/api/backups` | Daftar file backup (site tar.gz + DB sql.gz) | admin |
...
| Method | Endpoint | Fungsi | Akses |
|---|---|---|---|
| GET | `/api/ftp` | Daftar akun FTP (+ domain site) | login |
